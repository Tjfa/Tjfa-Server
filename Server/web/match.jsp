			...
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody>
					<%
                                        ...
                                        %>
                                        <tr>
                                            <td><input type="text" value="match+<%=i%>" onblur="changeDrop2(<%=i%>)" id="name<%=i%>"  onfocus="initContent(<%=i%>)"></td>
                                            <td>competition<%=i/5%></td>
                                            <td>A</td>
                                           
                                            <td>1</td>
                                            <td>1</td>
                                            <td>team<%out.println(i);%></td>
                                            <td>team<%out.println(i);%></td>
                                            <td>team<%out.println(i+1);%></td>
                                        </tr>
                                        <%
                                        }
                                        %>
