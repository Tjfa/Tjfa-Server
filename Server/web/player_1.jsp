        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="">
                <a href="http://v2.bootcss.com/getting-started.html">起步</a>
              </li>
              <li class="">
                <a href="http://v2.bootcss.com/scaffolding.html">脚手架</a>
              </li>
              <li class="">
                <a href="http://v2.bootcss.com/base-css.html">基本CSS样式</a>
              </li>
              <li class="active">
                <a href="http://v2.bootcss.com/components.html">组件</a>
              </li>
              <li class="">
                <a href="http://v2.bootcss.com/javascript.html">JavaScript插件</a>
              </li>
              <li class="">
                <a href="http://v2.bootcss.com/customize.html">定制</a>
              </li>
            </ul>
          </div>
        </div>
