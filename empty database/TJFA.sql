...
--
-- Host: localhost
-- Generation Time: Jul 04, 2014 at 05:23 AM
...
CREATE TABLE IF NOT EXISTS `Competition` (
  ...
  `isStart` smallint(5) NOT NULL DEFAULT '0' COMMENT '赛事是否开始 0未开始的赛事 1已经开始 2已经结束',
...
CREATE TABLE IF NOT EXISTS `Match` (
  ...
  `matchProperty` smallint(5) NOT NULL COMMENT '比赛性质 小组赛或者淘汰赛 0小组赛 1淘汰赛',
...
CREATE TABLE IF NOT EXISTS `Team` (
  ...
  `score` int(32) NOT NULL COMMENT '小组赛积分',
